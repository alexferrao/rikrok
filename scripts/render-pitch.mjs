...
const CLIPS = [
  ...
  { id: "pitch-3-voice", kind: "voice", label: "The difference", lines: ["Narrated in", "*your own voice*.", "And it never leaves", "your machine."], narration: process.env.PITCH_VARIANT === "silent" ? "Narrated in your own voice, from twenty seconds of you. No cloud, no upload. The voice, the script, the render: all on your machine." : "Narrated in your own voice, from twenty seconds of you. No cloud, no upload. The voice, the script, the render: all on your machine. This is my voice, by the way.", minSec: 11 },
